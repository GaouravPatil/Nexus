...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 56" fill="none" width="72" height="72">
...
# Optional — Supabase PostgreSQL connection string (automatically falls back to local SQLite nexus.db if omitted or unreachable)
